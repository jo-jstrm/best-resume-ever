...
<div class="resume">
  <div class="leftCol m_box">
    ...
    <a v-if="person.contact.xing" :href="contactLinks.xing" target="_blank">
      <div class="item">
        <div class="icon">
    ...
    <div v-if="person.skills" class="item">
      <div class="section-headline">
        {{ lang.skills }}
      </div>
    ...
    <div v-if="person.languages" class="item">
      <div class="section-headline">
        {{ lang.languages }}
      </div>
...
const name = 'material-dark-custom';
